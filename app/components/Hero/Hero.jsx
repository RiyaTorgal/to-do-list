...
const Hero = () => {
    ...
    <div className='hero mt-40'>
        ...
        <button className="mt-4 p-3 rounded-md leading-5 text-white transition-colors duration-200 transform bg-sky-900 hover:bg-sky-950  focus:outline-none">Create List</button>
        </Link>
        </div>
    </div>
    )
